...
public class GoldCoinSpawner : MonoBehaviour
{
    ...
    public float coinLifetime = 10.0f;  // Time in seconds before coins are destroyed.
    ...
    private void SpawnCoins()
    {
        for (int i = 0; i < numberOfCoinsToSpawn; i++)
        {
            ...
            float randomX = Random.Range(-spawnAreaSize / 3, spawnAreaSize / 3);
            float randomZ = Random.Range(-spawnAreaSize / 3, spawnAreaSize / 3);
